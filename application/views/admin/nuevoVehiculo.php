...
<head>
    ...
    <script language="JavaScript" type="text/javascript" src="<?php echo base_url(); ?>assets/js/validarVehiculo.js">
    </script>
    ...
    function confirmar() {
        ...
        Swal.fire({
            title: '¿Está seguro que desea crear el registro para éste vehículo?',
            type: 'warning',
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div class="pageheader hidden-xs">
                    <h3><i class="fa fa-home"></i> Creación de Nuevo Vehículo</h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Datos del nuevo vehículo</h3>
                                </div>
                                          ...
                                          si los datos se actualizan y hacen bien su proceso en el controlador Users y en el respectivo modelo. -->
                                            <?php if ($response =="1") {
                                                echo "<div class=\"alert alert-primary fade in\" role=\"alert\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">
                                                      Se guardaron correctamente los datos del nuevo vehículo
                                                    </div>";
                                              } ?>
                                            ...
                                            <form id="formulario" name="formulario" class="form-horizontal"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-1 col-xs-12 control-label">Placa</label>
                                                    <div class="col-md-3 col-xs-12">
                                                        <input type="text" class="form-control" name="placa" id="placa"
                                                            placeholder="Ingrese una placa" required />
                                                    </div>

                                                    <label class="col-md-1 col-xs-12 control-label">Marca</label>
                                                    <div class="col-md-3 col-xs-12">

                                                        <input type="text" class="form-control" name="marca"
                                                            id="marca" placeholder="Ingrese una marca" required />

                                                    </div>

                                                    <label class="col-md-1 col-xs-12 control-label">Tipo de
                                                        vehículo</label>
                                                    <div class="col-md-3 col-xs-12">
                                                        <input type="text" class="form-control" name="tipo" id="tipo"
                                                            placeholder="Ingrese Tipo" required />
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-1 col-xs-12 control-label">Modelo</label>
                                                    <div class="col-md-3 col-xs-12">

                                                        <input type="text" class="form-control" name="modelo"
                                                            id="modelo" placeholder="Ingrese un modelo" required />

                                                    </div>
                                                    <label class="col-md-1 col-xs-12 control-label">Color del
                                                        Vechículo</label>
                                                    <div class="col-md-3 col-xs-12">

                                                        <input type="text" class="form-control" name="color" id="color"
                                                            placeholder="Ingrese un color" required />
                                                ...
                                                <div class="panel-footer">
                                                    <div class="form-group">
                                                        <div class="col-md-5 col-xs-12">
                                                            ...
                                                            <a href="<?php echo base_url(); ?>index.php/vehiculos"
