                                    ...
                                    <table class="table table-striped table-bordered">
                                      ...
                                      ?>
                                            ...
                                            los datos del usuario que queremos editar-->
                                                 <a href="<?php echo base_url(); ?>index.php/ubicacion/mapa?id=<?= $datosoli->idRpPedidos; ?>&latitud=<?=$datosoli->latitud; ?>&longitud=<?=$datosoli->longitud; ?>" class="btn btn-success" data-toggle="tooltip" data-placement="left" title="Muestra la localización en un mapa"><span class="material-icons">public</span></a>
