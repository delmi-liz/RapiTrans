        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <div class="pageheader hidden-xs">
                    ...
                    <h3><i class="fa fa-home"></i>Tablas</h3>
                </div>
                <div id="page-content">
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           echo "<div class=\"alert alert-success fade in\" role=\"alert\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th>Campos de producción</th>

                                                <th>Alta Verapaz</th>

                                                <th>Quetzaltenango</th>

                                                <th>Antigua Guatemala</th>
                                        ...
                                        <tbody align="center">
                                            <?php foreach ($datosOfertaDemanda as $datosOfertaDemanda){
                                      // code...
                                      ?>
                                            <tr>
                                                <!-- Llamado de campos de los datos que queremos mostrar  -->
                                                <td><?= $datosOfertaDemanda->Campos_produccion ?></td>

                                                <td><?= $datosOfertaDemanda->Alta_Verapaz ?></td>

                                                <td><?= $datosOfertaDemanda->Quetzaltenango ?></td>

                                                <td><?= $datosOfertaDemanda->Antigua ?></td>

                                                <td><?= $datosOfertaDemanda->oferta ?></td>
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody align="center">
                                            <?php foreach ($costos as $costos){
                                      // code...
                                      ?>
                                            <tr>
                                                <!-- Llamado de campos de los datos que queremos mostrar  -->
                                                <td><?= $costos->Campos_produccion ?></td>

                                                <td><?= $costos->Alta_Verapaz ?></td>

                                                <td><?= $costos->Quetzaltenango ?></td>

                                                <td><?= $costos->Antigua ?></td>
