                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           echo "<div class=\"alert alert-success fade in\" role=\"alert\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">
                                 Usted ha iniciado el pedido con éxito.
                               </div>";
                         } ?>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li> <a href="<?php echo base_url(); ?>index.php/ubicacion/mapa?id=<?= $datosoli->idRpPedidos; ?>&latitud=<?=$datosoli->latitud; ?>&longitud=<?=$datosoli->longitud; ?>"
                                                                    class="btn btn-success" data-toggle="tooltip"
                                                                    data-placement="left"
                                                                    title="Muestra la localización en un mapa"><span
                                                                        class="material-icons">public</span></a></li>

                                                            <li> <a href="<?php echo base_url(); ?>index.php/ubicacion?id=<?= $datosoli->idRpPedidos; ?>"
                                                                    class="btn btn-primary" data-toggle="tooltip"
                                                                    data-placement="left"
                                                                    title="Mostrar ruta optima"><span
                                                                        class="material-icons">location_on</span></a>
                                                            </li>

                                                            <li> <a href="<?php echo base_url(); ?>index.php/ubicacion/finalizar?id=<?= $datosoli->idRpPedidos; ?>"
                                                                    class="btn btn-secondary" data-toggle="tooltip"
                                                                    data-placement="left"
                                                                    title="Finalizar pedido"><span
