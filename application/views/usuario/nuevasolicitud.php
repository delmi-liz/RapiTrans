...
<head>
  ...
  #regiration_form fieldset:not(:first-of-type) {
    ...
    function confirmar() {
        ...
        Swal.fire({
            title: '¿Está seguro que desea crear la Solicitud?',
            type: 'warning',
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <?php if ($response == "1") {
                                                echo "<div class=\"alert alert-primary fade in\" role=\"alert\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">
                                                    La Solcitud ha sido ingresada exitosamente al sistema de RapiTrans, su código asignado es: 'RapiTrans-".$codigoSolicitud."-2021'.
                                                    </div>";
                                            } ?>
                                            ...
                                            <form id="registrationForm" name="registrationForm" class="form-horizontal"
                                                action="guardar" onsubmit="return confirmar()" method="GET">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-md-1 col-xs-12 control-label">Ingrese latitud
                                                    </label>
                                                    <div class="col-md-3 col-xs-12">
                                                        <input type="text" class="form-control" name="latitud"
                                                            id="latitud" placeholder="Ingrese latitud de su ubicación"
                                                            required />
                                                    </div>

                                                    <label class="col-md-1 col-xs-12 control-label">Ingrese longitud
                                                    </label>
                                                    <div class="col-md-3 col-xs-12">
                                                        <input type="text" class="form-control" name="longitud"
                                                            id="longitud" placeholder="Ingrese longitud de su ubicación"
                                                            required />
                                                    </div>

                                                    <label class="col-md-1 col-xs-12 control-label">Teléfono
                                                    </label>
                                                    <div class="col-md-3 col-xs-12">
                                                        <input type="text" class="form-control" name="telefono"
                                                            id="telefono" placeholder="Ingrese un teléfono" required />
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        <textarea rows="4" maxlength="200" id="mensaje" name="desc" id="desc"
                                                            rows="4" cols="96"
                                                    ...
                                                    <label class="col-md-5 col-xs-11 control-label">Producto</label>
                                                    <div class="col-md-3 col-xs-12">
                                                        <select class="form-control" name="producto" id="producto"
                                                            required>
                                                            <option value="" hidden selected>Seleccione un producto
                                                            </option>
                                                            ...
                                                            <option value="<?= $producto->idProductos  ?>">
                                                                <?= $producto->descripcionProducto ?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-md-1 col-xs-12 control-label">Correo
                                                    </label>
                                                    <div class="col-md-3 col-xs-12">
                                                        <input type="email" class="form-control" name="correo"
                                                            id="correo" placeholder="Ingrese un correo" required />
                                                    </div>
